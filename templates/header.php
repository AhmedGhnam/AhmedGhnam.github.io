...
<nav dir="ltr" class="navbar navbar-star <?php if(htmlspecialchars($_SERVER['PHP_SELF']) == '/Star/ahmedghnam.github.io/employees.php') {echo 'employees';}?> navbar-expand-lg bg-dark">
    <div class="container">
